...
func (t *implCertificateService) GetOrCreateAcmeUser(email string) (user *cert.AcmeUser, err error) {
...
func (t *implCertificateService) getOrCreateSelfIssuer(cn string) (cert.CertificateIssuer, error) {
...
func (t *implCertificateService) IssueSelfSignedCertificate(entry *certpb.Zone) error {
	...
	entry.Certificates = &certpb.Certificates{
		Domain:            entry.Zone,
		CertUrl:           "",
		CertStableUrl:     "",
...
func wrapAcmeResource(r *registration.Resource) *cert.AcmeResource {
	return &cert.AcmeResource{
		Body: cert.AcmeAccount{
			Status:                 r.Body.Status,
			Contact:                r.Body.Contact,
			TermsOfServiceAgreed:   r.Body.TermsOfServiceAgreed,
			Orders:                 r.Body.Orders,
...
func (t *implCertificateService) listCerts(args []string) (string, error) {
	...
	err := t.CertificateRepository.ListZones(prefix, func(entry *certpb.Zone) bool {
...
func (t *implCertificateService) acmeList(args []string) (string, error) {
	...
	err := t.CertificateRepository.ListAccounts("", func(account *certpb.AcmeAccount) bool {
...
func (t *implCertificateService) selfList(args []string) (string, error) {
	...
	err := t.CertificateRepository.ListSelfSigners("", func(self *certpb.SelfSigner) bool {
