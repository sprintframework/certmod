...
func CertificateIssueService() cert.CertificateIssueService {
...
func (t *implCertificateIssuerService) LoadCertificateDesc() (*cert.CertificateDesc, error) {

	certName := &cert.CertificateDesc{
...
func (t *implCertificateIssuerService) CreateIssuer(cn string, info *cert.CertificateDesc) (cert.CertificateIssuer, error) {
...
func (t *implCertificateIssuerService) LoadIssuer(issuer *certpb.SelfSigner) (cert.CertificateIssuer, error) {
	return t.loadIssuerRecursive(issuer)
}

func (t *implCertificateIssuerService) loadIssuerRecursive(issuer *certpb.SelfSigner) (*certificateIssuer, error) {
...
func (t *certificateIssuer) Parent() (cert.CertificateIssuer, bool) {
	return t.parent, t.parent != nil
}

func (t *certificateIssuer) Certificate() cert.IssuedCertificate {
	return t.cert
}

func (t *certificateIssuer) IssueInterCert(cn string) (cert.CertificateIssuer, error) {
...
func (t *certificateIssuer) IssueClientCert(cn string, password string) (cert cert.IssuedCertificate, pfxData []byte, err error) {
...
func (t *certificateIssuer) IssueServerCert(cn string, domains []string, ipAddresses []net.IP) (cert cert.IssuedCertificate, err error) {
...
func (t *implCertificateIssuerService) makeIntermediateCert(cn string, desc *cert.CertificateDesc, key crypto.Signer, rootCert *x509.Certificate, rootKey crypto.Signer) (*x509.Certificate, []byte, error) {
	serial, err := rand.Int(rand.Reader, big.NewInt(math.MaxInt64))
	if err != nil {
		return nil, nil, err
	}
...
func (t *implCertificateIssuerService) makeRootIssuer(cn string, desc *cert.CertificateDesc) ([]byte, []byte, error) {
