...
func (t *implDynDNSService) EnsureAllPublic(subDomains ...string) error {
	...
	return t.EnsureCustom(func(client dns.DNSProviderClient, zone string, externalIP string) error {
		return t.doEnsureAllPublic(client, zone, externalIP, subDomains)
	})

}

func (t *implDynDNSService) EnsureCustom(cb func(client dns.DNSProviderClient, zone string, externalIP string) error) error {

	var list []*certpb.Zone

	err := t.CertificateRepository.ListZones("", func(entry *certpb.Zone) bool {
...
func (t *implDynDNSService) doEnsureAllPublic(client dns.DNSProviderClient, zone string, externalIP string, subDomains []string) error {
